---
layout: default
title: Documentação da Restrição de Acesso PlayerHUD
lang: pt
---
...
[![Last Commit](https://img.shields.io/github/last-commit/jeanlucio/moodle-availability_playerhud?style=flat)](https://github.com/jeanlucio/moodle-availability_playerhud/commits)
[![Open Issues](https://img.shields.io/github/issues/jeanlucio/moodle-availability_playerhud?style=flat)](https://github.com/jeanlucio/moodle-availability_playerhud/issues)
...
Ela se conecta diretamente ao sistema nativo de **Restringir acesso** do Moodle, liberando
conteúdo apenas quando o estudante atinge um determinado **Nível**, possui um **Item**
necessário, pertence a uma **Classe de personagem**, ou tem a **gamificação ativa**.
