...
/**
 * Language strings for availability_playerhud (Brazilian Portuguese).
 *
...
$string['missing'] = '(Faltam dados)';
$string['op_atleast'] = 'pelo menos';
$string['op_equal'] = 'exatamente';
$string['op_less'] = 'menos que';
$string['op_more'] = 'mais que';
$string['op_text_atleast'] = 'pelo menos';
$string['op_text_equal'] = 'exatamente';
$string['op_text_less'] = 'menos que';
$string['op_text_more'] = 'mais que';
$string['option_class'] = 'Personagem';
$string['option_gamification'] = 'Gamificação Ativa';
...
$string['requires_gamification_active'] = 'Você precisa ter a <strong>gamificação ativa</strong>.';
...
$string['requires_not_class'] = 'Seu personagem não deve ser <strong>{$a}</strong>.';
$string['requires_not_gamification_active'] = 'Você não deve ter a <strong>gamificação ativa</strong>.';
$string['requires_not_item'] = 'Você não deve ter <strong>{$a->op} {$a->qty}x {$a->item}</strong>.';
$string['requires_not_level'] = 'Você não deve ter alcançado o <strong>Nível {$a}</strong>.';
