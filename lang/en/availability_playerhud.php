...
$string['option_gamification'] = 'Gamification Enabled';
...
$string['requires_gamification_active'] = 'You must have <strong>gamification enabled</strong>.';
...
$string['requires_not_class'] = 'Your character must not be <strong>{$a}</strong>.';
$string['requires_not_gamification_active'] = 'You must not have <strong>gamification enabled</strong>.';
$string['requires_not_item'] = 'You must not have <strong>{$a->op} {$a->qty}x {$a->item}</strong>.';
$string['requires_not_level'] = 'You must not have reached <strong>Level {$a}</strong>.';
